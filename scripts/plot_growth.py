...
ax1.bar(dates, new_clicks, color=bar_color, alpha=0.7, label='New clicks per run', width=0.8)
...
ax1.set_xlabel('Date')
ax1.set_ylabel('New Clicks per Run', color='#333')
...
ax1.set_title('GeoScents Activity — New Clicks Per Day + Cumulative Total')
plt.tight_layout()
